...
<link href="wishlist.css" rel="stylesheet" type="text/css">	
	...
	?>
	<p><h2><?php=$name.(endsWith($name,'s') ? "" : "s").' önskelista'?></br>
	...
	if(isset($logedinuser) || (isset($selectedUser['familyid']) == isset($_SESSION['userid']))) {
		...
		<form action=wishList.php name=edit method=get>
			...
			<table border=0 cellpadding=2 cellspacing=0>
				<tr>
					<td style="text-align:right">Önskan:</td><td><input class=edit type=text size=40 name=editWish value="<?php=isset($wishToEdit['wish'])?>"></td>
				</tr>
				<tr>
					<td style="text-align:right">ev. Länk:</td><td><input class=edit type=url size=40 name=editLink value=<?php=isset($wishToEdit['link'])?>></td>
				</tr>
				<tr>
