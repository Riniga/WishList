<?php include("../../xampp/langsettings.php");
#session_start(); 
...
//we're using sessions so this is required!
...
<tr><td style="text-align:right">Användarnamn:&nbsp; </td><td><input type=text size=30 name=namn value=<?php isset($_SESSION['username']) ?>></td></tr>
